defmodule INA219.Commands do
  ...
  def bus_voltage_range(pid, 16) do
    conf = Registers.configuration(pid)
    conf = conf &&& -0x2001 # ~~~(1 <<< 13)
    Registers.configuration(pid, conf)
  end

  def bus_voltage_range(pid, 32) do
    conf = Registers.configuration(pid)
    conf = conf ||| 0x2000 # (1 <<< 13)
    Registers.configuration(pid, conf)
  end
  ...
  * `{128, 12}` - 128 sample averaging and 12 bit ADB resolution.
  """
  def bus_adc_resolution_and_averaging(pid, {  1,  9}), do: set_bus_adc_resolution_and_averaging(pid, 0)
  def bus_adc_resolution_and_averaging(pid, {  1, 10}), do: set_bus_adc_resolution_and_averaging(pid, 1)
  def bus_adc_resolution_and_averaging(pid, {  1, 11}), do: set_bus_adc_resolution_and_averaging(pid, 2)
  def bus_adc_resolution_and_averaging(pid, {  1, 12}), do: set_bus_adc_resolution_and_averaging(pid, 3)
  def bus_adc_resolution_and_averaging(pid, {  2, 12}), do: set_bus_adc_resolution_and_averaging(pid, 9)
  def bus_adc_resolution_and_averaging(pid, {  4, 12}), do: set_bus_adc_resolution_and_averaging(pid, 10)
  def bus_adc_resolution_and_averaging(pid, {  8, 12}), do: set_bus_adc_resolution_and_averaging(pid, 11)
  def bus_adc_resolution_and_averaging(pid, { 16, 12}), do: set_bus_adc_resolution_and_averaging(pid, 12)
  def bus_adc_resolution_and_averaging(pid, { 32, 12}), do: set_bus_adc_resolution_and_averaging(pid, 13)
  def bus_adc_resolution_and_averaging(pid, { 64, 12}), do: set_bus_adc_resolution_and_averaging(pid, 14)
  def bus_adc_resolution_and_averaging(pid, {128, 12}), do: set_bus_adc_resolution_and_averaging(pid, 15)
  ...
  * `{128, 12}` - 128 sample averaging and 12 bit ADB resolution.
  """
  def shunt_adc_resolution_and_averaging(pid, {  1,  9}), do: set_shunt_adc_resolution_and_averaging(pid, 0)
  def shunt_adc_resolution_and_averaging(pid, {  1, 10}), do: set_shunt_adc_resolution_and_averaging(pid, 1)
  def shunt_adc_resolution_and_averaging(pid, {  1, 11}), do: set_shunt_adc_resolution_and_averaging(pid, 2)
  def shunt_adc_resolution_and_averaging(pid, {  1, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 3)
  def shunt_adc_resolution_and_averaging(pid, {  2, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 9)
  def shunt_adc_resolution_and_averaging(pid, {  4, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 10)
  def shunt_adc_resolution_and_averaging(pid, {  8, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 11)
  def shunt_adc_resolution_and_averaging(pid, { 16, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 12)
  def shunt_adc_resolution_and_averaging(pid, { 32, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 13)
  def shunt_adc_resolution_and_averaging(pid, { 64, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 14)
  def shunt_adc_resolution_and_averaging(pid, {128, 12}), do: set_shunt_adc_resolution_and_averaging(pid, 15)
